...
protected:
  ...
  void getIntegratedFluxes(const double astar, ints& modes, doubles& fluxes, const double wMax) const;
  double generateFromMorphedCurve(const int mode, const double astar, const double wMax) const;
