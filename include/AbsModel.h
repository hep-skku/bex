...
protected:
  ...
  double generateFromMorphedCurve(const int mode, const double astar, const double wMin, const double wMax) const;
  double interpolateInvCDF(const double c, const doubles& xValues, const doubles& yValues, const doubles& cValues) const;
